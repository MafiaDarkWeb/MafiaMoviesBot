...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, AUTO_DELETE, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, START_MESSAGE, FORCE_SUB_TEXT, SUPPORT_CHAT
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/+VfeOHeNBNFU4NDc9")
            ],[      
...
async def settings(client, message):
    ...
    if settings is not None:
        buttons = [[
                ...
                InlineKeyboardButton('𝐀𝐔𝐓𝐎 𝐃𝐄𝐋𝐄𝐓𝐄', callback_data=f'setgs#auto_delete#{settings["auto_delete"]}#{grp_id}',),
                InlineKeyboardButton('✅𝟑𝟎 𝐌𝐈𝐍𝐒' if settings["auto_delete"] else '🗑️𝐎𝐅𝐅', callback_data=f'setgs#auto_delete#{settings["auto_delete"]}#{grp_id}',),
                ],[
